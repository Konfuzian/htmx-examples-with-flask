...
def index(page):
    return render_template("click_to_load/index.html.j2", contacts=generate_contacts(page=page), page=page)


@bp.route("/contacts/")
def contacts():
    page = int(request.args.get("page", 1))
    return render_template("click_to_load/partial.html.j2", contacts=generate_contacts(page=page), page=page)
